  ...
  <BrowserRouter>
    <Routes>
      <Route path="" element={<HomeTemplates />}>
        ...
        <Route path='useeffectdidmountdemo' element={<UseEffectDidMountDemo/>}></Route>
        <Route path='useeffectwillunmountdemo' element={<UseEffectWillUnmountDemo/>}></Route>
        <Route path='useeffectdidupdate' element={<UseEffectDidUpdate/>}></Route>
        <Route path='usecallbackdemo' element={<HookUseCallBack/>}></Route>
        <Route path='usememodemo' element={<UseMemoDemo/>}></Route>
        <Route path='userefdemo' element={<UseRefDemo/>}></Route>
        <Route path='reduxdemo' element={<UseReduxDemo/>}></Route>
      </Route>
    </Routes>
  </BrowserRouter>
  </Provider>
